...
export default function VolunteerPage() {
  return (
    <section className="mx-auto max-w-6xl px-5 py-16">
      <p className="text-xs uppercase tracking-[0.25em] text-gold">Let’s march</p>
      <h1 className="mt-3 font-display text-5xl text-black">Get involved</h1>
      ...
      <div className="mt-12 grid gap-4 md:grid-cols-2">
        {volunteerRoles.map((role) => (
          <article key={role.title} className="rounded-2xl border border-black/10 bg-pink p-6">
