  ...
  return (
    <section className="mx-auto max-w-4xl px-5 py-16">
      <div className="text-center">
        <p className="text-xs font-semibold uppercase tracking-[0.25em] text-gold">Partner through giving</p>
        ...
        <p className="mt-4 text-sm font-semibold uppercase tracking-[0.2em] text-gold">Luke 6:38 KJV</p>
      ...
      <div className="mt-12 grid gap-6 md:grid-cols-2">
        ...
        <article className="rounded-3xl border border-black/10 bg-pink p-8">
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-red">Zelle</p>
