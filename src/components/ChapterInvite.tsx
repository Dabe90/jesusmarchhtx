  ...
  return (
    <section id="chapters" className="scroll-mt-24 overflow-hidden bg-paper px-4 py-16 sm:px-5 md:py-24">
      <div className="mx-auto grid max-w-7xl items-end gap-10 lg:grid-cols-[0.9fr_1.1fr]">
        <div>
          <Kicker>Plant the Word</Kicker>
          <h2 className="mt-3 text-3xl font-bold tracking-tight text-midnight sm:text-4xl md:text-5xl">
            Start a chapter
            <span className="mt-1 block font-normal italic text-navy">in your city or on campus</span>
          </h2>
